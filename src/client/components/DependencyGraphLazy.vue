...
import type { DependencyGraphProps } from './DependencyGraph.vue';
...
const enableInteractionMetrics = import.meta.env.DEV && import.meta.env['VITE_GRAPH_INTERACTION_METRICS'] === 'true';
